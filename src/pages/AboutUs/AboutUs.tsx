        ...
        <div className="content-container">
            <div className="content">
                ...
                <div className="article">
                    <p>Skydive Brooklyn was founded in 1996, by Dean Winchester, who is renowned worldwide as a superior skydiver!  Dean took his first plunge out of a moving aircraft as a U.S military paratrooper in 1985.  Dean proudly served in Dessert Storm and decided to pursue his recreational love for skydiving, upon his departure from the U.S military in 1995.  Born and bred in Brooklyn, it was only natural that he founded his base of operations in his native Borough.  So began the humble foundation of Skydive Brooklyn, with one aircraft and two dedicated employees.</p>
                    <p>Through word of mouth and a grassroots marketing campaign, Skydive Brooklyn had expanded its operations to 5 aircraft and 10 employees by 1998 and attained membership to USPA (United States Parachute Association).  In 2000 Skydive relocated to a nearby facility including private runway, which the company now owns and operates.  We now boast an impressive 10 aircraft with over 20 certified instructors, who rule the clouds in NYC.  We also proudly consult with paratroop divisions of the US military, which further demonstrates our vast superiority in the industry.  So come join us for an unforgettable experience!!</p>
                </div>
                <h2>Our Facility</h2>
                <div className="sbs">
